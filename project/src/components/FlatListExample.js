...
import {StyleSheet, View, Text, SafeAreaView, FlatList, Image, TouchableOpacity, TextInput , ActivityIndicator,Platform} from 'react-native';
import axios from 'axios';

const isIos =Platform.OS==='ios';

export default class FlatListExample extends Component {
	state = { /*field tanımları */
		text: '',
		page:1,
		contacts: [],
		allContacts: [],
  ...
  onRefresh=()=> {
    ...
    renderFooter = ()  => {
            /**yüklenirken işletim sistemine uygun yükleniyor simgesi ActivityIndicator çalışmıyor muhtemelen kütüphane değişti*/
	...
	render() {
		return (
			<FlatList
				...
				keyExtractor={item => item.login.uudi}
				data={this.state.contacts}
				
				onEndReached={this.loadMore} /*en dibe indirdiğimizde çalışacak olan method */
				onEndReachedThreshold={isIos ? 0: .2} /*en dibe indiğinde yeni veriler gelir */
